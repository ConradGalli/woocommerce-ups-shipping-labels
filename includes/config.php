...
// shipper information
$config['shipper_name'] = 'David Jensen'; 
$config['shipper_attention_name'] = ''; 
$config['shipper_phone'] = '4258292246'; 
$config['shipper_email'] = 'david@dkjensen.com';
$config['shipper_address1'] = '4611 113th St SE'; 
$config['shipper_address2'] = '';
$config['shipper_address3'] = ''; 
$config['shipper_city'] = 'Everett';
$config['shipper_state'] = 'WA'; 
$config['shipper_postal_code'] = '98208'; 
